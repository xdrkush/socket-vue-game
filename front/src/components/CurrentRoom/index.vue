<template>
  <div class="bg-dark txt-light" style="padding: 5px">
    ...
    <div
      ...
      class="justify_between bdr-b-primary"
      @click="info = !info"
    >
      <p v-if="store.getCurrentRoom.author.username">
        By: @{{ store.getCurrentRoom.author.username }}
      </p>
      <p>
        Players:
        <span
    ...
    <div v-if="info" class="justify_between">
      <div class="w-50 pa-1">
        <!-- Players -->
        <div class="bdr-b-primary py-1">
          <h5 class="my-1">Players</h5>
          <ul
          ...
          >
            ...
            >
              ...
              <button
                v-if="choosePlayer"
                @click="() => selectPlayer(choosePlayer, store.getCurrentRoom)"
              >
                OK
              </button>
