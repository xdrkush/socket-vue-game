...
.bdr-primary { border: solid 2px var(--color-primary); border-radius: var(--radius)}
.bdr-secondary { border: solid 2px var(--color-secondary); border-radius: var(--radius)}
.bdr-accent { border: solid 2px var(--color-accent); border-radius: var(--radius)}
.bdr-light { border: solid 2px var(--color-light); border-radius: var(--radius)}
.bdr-dark { border: solid 2px var(--color-dark); border-radius: var(--radius)}
.bdr-positive { border: solid 2px var(--color-positive); border-radius: var(--radius)}
.bdr-negative { border: solid 2px var(--color-negative); border-radius: var(--radius)}
.bdr-warning { border: solid 2px var(--color-warning); border-radius: var(--radius)}

.bdr-b-primary { border-bottom: solid 1px var(--color-primary);}
.bdr-bt-primary { border-top: solid 1px var(--color-primary);}
...
.w-100-vw { max-width: 100vw; width: 100vw }
.w-50 { width: 50% }
.w-50-vh { height: 50vh }
.w-50-vw { max-width: 50vw; width: 50vw }
